...
const (
  ConsistencyLevel_INVALID ConsistencyLevel = 0
...
type Replica interface {
  ...
  //  - Key
  //  - CLevel
  Get(ctx context.Context, key int32, cLevel ConsistencyLevel) (r string, err error)
  // Parameters:
  //  - Key
  //  - Value
  //  - CLevel
  Put(ctx context.Context, key int32, value string, cLevel ConsistencyLevel) (err error)
  // Parameters:
  //  - Key
  GetDataFromNode(ctx context.Context, key int32) (r *KVData, err error)
  // Parameters:
  //  - Data
  PutDataInNode(ctx context.Context, data *KVData) (err error)
  // Parameters:
  //  - Node
  GetHints(ctx context.Context, node *Node) (r []*KVData, err error)
}
...
func NewReplicaClient(c thrift.TClient) *ReplicaClient {
  return &ReplicaClient{
    c: c,
  }
}

func (p *ReplicaClient) Client_() thrift.TClient {
  return p.c
}
// Parameters:
//  - Key
//  - CLevel
func (p *ReplicaClient) Get(ctx context.Context, key int32, cLevel ConsistencyLevel) (r string, err error) {
  var _args0 ReplicaGetArgs
  _args0.Key = key
  _args0.CLevel = cLevel
  var _result1 ReplicaGetResult
...
//  - Value
//  - CLevel
func (p *ReplicaClient) Put(ctx context.Context, key int32, value string, cLevel ConsistencyLevel) (err error) {
  var _args2 ReplicaPutArgs
  _args2.Key = key
  _args2.Value = value
  _args2.CLevel = cLevel
  var _result3 ReplicaPutResult
  if err = p.Client_().Call(ctx, "put", &_args2, &_result3); err != nil {
    return
  }
  switch {
  case _result3.SystemException!= nil:
    return _result3.SystemException
  }
...
// Parameters:
//  - Key
func (p *ReplicaClient) GetDataFromNode(ctx context.Context, key int32) (r *KVData, err error) {
  var _args4 ReplicaGetDataFromNodeArgs
  _args4.Key = key
  var _result5 ReplicaGetDataFromNodeResult
  if err = p.Client_().Call(ctx, "getDataFromNode", &_args4, &_result5); err != nil {
    return
  }
  switch {
  case _result5.SystemException!= nil:
    return r, _result5.SystemException
  }
...
// Parameters:
//  - Data
func (p *ReplicaClient) PutDataInNode(ctx context.Context, data *KVData) (err error) {
  var _args6 ReplicaPutDataInNodeArgs
  _args6.Data = data
  var _result7 ReplicaPutDataInNodeResult
  if err = p.Client_().Call(ctx, "putDataInNode", &_args6, &_result7); err != nil {
    return
  }
  switch {
  case _result7.SystemException!= nil:
    return _result7.SystemException
  }
...
// Parameters:
//  - Node
func (p *ReplicaClient) GetHints(ctx context.Context, node *Node) (r []*KVData, err error) {
  var _args8 ReplicaGetHintsArgs
  _args8.Node = node
  var _result9 ReplicaGetHintsResult
  if err = p.Client_().Call(ctx, "getHints", &_args8, &_result9); err != nil {
    return
  }
  switch {
...
func (p *ReplicaProcessor) Process(ctx context.Context, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
...
func (p *replicaProcessorGet) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  args := ReplicaGetArgs{}
...
var retval string
  var err2 error
  if retval, err2 = p.handler.Get(ctx, args.Key, args.CLevel); err2 != nil {
  switch v := err2.(type) {
...
func (p *replicaProcessorPut) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  args := ReplicaPutArgs{}
  if err = args.Read(iprot); err != nil {
    iprot.ReadMessageEnd()
    x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
  ...
  var err2 error
  if err2 = p.handler.Put(ctx, args.Key, args.Value, args.CLevel); err2 != nil {
  switch v := err2.(type) {
    case *SystemException:
  result.SystemException = v
    default:
...
func (p *replicaProcessorGetDataFromNode) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
...
var retval *KVData
  var err2 error
  if retval, err2 = p.handler.GetDataFromNode(ctx, args.Key); err2 != nil {
  switch v := err2.(type) {
    case *SystemException:
  result.SystemException = v
    default:
...
func (p *replicaProcessorPutDataInNode) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  var err2 error
  if err2 = p.handler.PutDataInNode(ctx, args.Data); err2 != nil {
  switch v := err2.(type) {
    case *SystemException:
  result.SystemException = v
    default:
...
func (p *replicaProcessorGetHints) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
...
var retval []*KVData
  var err2 error
  if retval, err2 = p.handler.GetHints(ctx, args.Node); err2 != nil {
  switch v := err2.(type) {
    case *SystemException:
  result.SystemException = v
    default:
